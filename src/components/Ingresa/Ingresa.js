        ...
        <Container>
          <Row>
            ...
            <Col className="box-titulo-ingresa" xs={12} md={12} lg={12} >
              ...
              <h4 className="titulo-form-ingresa">PROPUESTA O MEJORA</h4>
            </Col>
          ...
          <Col xs={12} md={12} lg={12} >
            <form onSubmit={this.onSubmit}>
             ...
             <div className="btn-sucess">
               <button  onClick={this.handleUpload} type="submit" className="btn btn-primary">REALIZAR PROPUESTA</button>
               </div> 
              <div className="volver"> <h6><Link to="/dashboard">Volver</Link></h6> </div>
